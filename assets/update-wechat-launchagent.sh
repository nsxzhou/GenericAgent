...
LOG_FILE="${LOG_DIR}/wechatapp.update.log"
UID_VALUE="$(id -u)"
REMOTE="${WECHAT_UPDATE_REMOTE:-origin}"
BRANCH="${WECHAT_UPDATE_BRANCH:-my-feature}"
RESTART_DELAY="${WECHAT_UPDATE_RESTART_DELAY:-2}"
